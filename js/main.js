...
const TAB_CONTENT = {
  heic: {
    ...
    desc:   { ko: 'HEIC → JPG 변환을 브라우저에서 직접 처리합니다.<br>파일이 서버로 전송되지 않아 완전히 안전합니다.', en: 'Convert iPhone HEIC photos to JPG instantly.<br>Free, private, and processed in your browser.' },
  ...
  compress: {
    ...
    desc:   { ko: 'PNG · JPG · WEBP를 브라우저에서 직접 압축합니다.<br>파일이 서버로 전송되지 않아 완전히 안전합니다.', en: 'Compress PNG, JPG and WEBP files in your browser.<br>Fast, free, and your files never leave your device.' },
  ...
  bgremove: {
    ...
    desc:   { ko: 'AI가 배경을 자동으로 인식하고 제거합니다.<br>결과물은 투명 PNG로 저장됩니다.', en: 'AI automatically detects and removes image backgrounds.<br>Output is saved as a transparent PNG.' },
